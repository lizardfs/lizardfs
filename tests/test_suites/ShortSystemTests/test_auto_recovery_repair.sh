...
chunk=$(find_chunkserver_chunks 0 -name "chunk_0000000000000002_00000001.???")
...
assert_equals 1 $(find_chunkserver_chunks 0 -name "chunk_0000000000000001_00000001.???" | wc -l)
assert_equals 1 $(find_chunkserver_chunks 1 -name "chunk_0000000000000001_00000002.???" | wc -l)
