...
chunk=$(find_chunkserver_chunks 0 -name "chunk_0000000000000002_00000001.lfs")
...
assert_equals 1 $(find_chunkserver_chunks 0 -name "chunk_0000000000000001_00000001.lfs" | wc -l)
assert_equals 1 $(find_chunkserver_chunks 1 -name "chunk_0000000000000001_00000002.lfs" | wc -l)
...
assert_awk_finds '/chunks with 0 copies: *2$/' "$(lfscheckfile dir/file)"

# Repair the file and remember metadata after the repair
repairinfo=$(lfsfilerepair dir/file)
...
assert_awk_finds_no '/chunks with 0 copies/' "$(lfscheckfile dir/file)"
