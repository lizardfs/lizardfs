...
one_kb_file_size=$(lfs_dir_info size file_kb)
one_chunk_file_size=$(lfs_dir_info size file_chunk)
soft=$((2*one_kb_file_size))
hard=$((3*one_kb_file_size))

lfssetquota -g $gid1 $soft $hard 0 0 .
lfssetquota -g $gid $soft $hard 0 0 .
