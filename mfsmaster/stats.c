...
#define STATS_UCPU 0
#define STATS_SCPU 1
#define STATS_DELCHUNK 2
#define STATS_REPLCHUNK 3
#define STATS_STATFS 4
#define STATS_GETATTR 5
#define STATS_SETATTR 6
#define STATS_LOOKUP 7
#define STATS_MKDIR 8
#define STATS_RMDIR 9
#define STATS_SYMLINK 10
#define STATS_READLINK 11
#define STATS_MKNOD 12
#define STATS_UNLINK 13
#define STATS_RENAME 14
#define STATS_LINK 15
#define STATS_READDIR 16
#define STATS_OPEN 17
#define STATS_READ 18
#define STATS_WRITE 19
/*
...
void stats_store (void) {
	...
	fd = open("stats.mfs",O_WRONLY | O_TRUNC | O_CREAT,0666);
	if (fd<0) {
...
void stats_refresh(void) {
	...
	data[STATS_DELCHUNK]=del;
	data[STATS_REPLCHUNK]=repl;
	fs_stats(fsdata);
	for (i=0 ; i<16 ; i++) {
		data[STATS_STATFS+i]=fsdata[i];
	}
/*
...
//	case CALC_GOODPERCENT:
	...
	case STATS_READ:
	case STATS_WRITE:
		scale = 2;		// standard - number per minute
		break;
	case STATS_UCPU:
	case STATS_SCPU:
	case EXT_CPU:
