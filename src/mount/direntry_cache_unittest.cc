...
TEST(DirEntryCache, Basic) {
	...
	cache.insertSubsequent(LizardClient::Context(0, 0, 0, 0), 9, 0, std::vector<DirectoryEntry>{{0, 1, 7, "a1", dummy_attributes}, {1, 2, 8, "a2", dummy_attributes}, {2, 3, 9, "a3", dummy_attributes}}, current_time);
	cache.insertSubsequent(LizardClient::Context(1, 2, 0, 0), 11, 7, std::vector<DirectoryEntry>{{7, 8, 5, "a1", dummy_attributes}, {8, 9, 4, "a2", dummy_attributes}, {9, 10, 3, "a3", dummy_attributes}}, current_time);
	cache.insertSubsequent(LizardClient::Context(0, 0, 0, 0), 9, 1, std::vector<DirectoryEntry>{{1, 2, 11, "a4", dummy_attributes}, {2, 3, 13, "a3", attributes_with_9}, {3, 4, 12, "a2", attributes_with_6}}, current_time);
...
TEST(DirEntryCache, Repetitions) {
	...
	cache.insertSubsequent(LizardClient::Context(0, 0, 0, 0), 9, 0, std::vector<DirectoryEntry>{{0, 1, 7, "a1", dummy_attributes}}, current_time);
	cache.insertSubsequent(LizardClient::Context(0, 0, 0, 0), 9, 1, std::vector<DirectoryEntry>{{1, 2, 7, "a1", dummy_attributes}}, current_time);
