...
* \attention This function should be used if entry should not reside in cache (i.e. opening a file
* failed)
* \param cache cache to be modified
* \param entry pointer returned from previous acquire() call
*/
...
* \post use this entry to call release() on entry->fileinfo and free entry afterwards with
