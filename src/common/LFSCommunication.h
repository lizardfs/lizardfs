...
#define LFSBLOCKSINCHUNK 0x400
#if LIGHT_LFS == 1
#  define LFSSIGNATURE "LFS"
#  define LFSCHUNKSIZE 0x00400000
#  define LFSCHUNKMASK 0x003FFFFF
#  define LFSCHUNKBITS 22
#  define LFSCHUNKBLOCKMASK 0x003FF000
#  define LFSBLOCKSIZE 0x1000
#  define LFSBLOCKMASK 0x0FFF
#  define LFSBLOCKNEGMASK 0x7FFFF000
#  define LFSBLOCKBITS 12
#  define LFSCRCEMPTY 0xC71C0011U
#  define LFSHDRSIZE 0x1080
#else
#  define LFSSIGNATURE "LFS"
#  define LFSCHUNKSIZE 0x04000000
#  define LFSCHUNKMASK 0x03FFFFFF
#  define LFSCHUNKBITS 26
#  define LFSCHUNKBLOCKMASK 0x03FF0000
#  define LFSBLOCKSIZE 0x10000
#  define LFSBLOCKMASK 0x0FFFF
#  define LFSBLOCKNEGMASK 0x7FFF0000
#  define LFSBLOCKBITS 16
#  define LFSCRCEMPTY 0xD7978EEBU
#  define LFSHDRSIZE 0x1400
#endif
...
#define LFS_ROOT_ID 1

#define LFS_NAME_MAX 255
#define LFS_MAX_FILE_SIZE (((uint64_t)(LFSCHUNKSIZE))<<31)

#define LFS_INODE_REUSE_DELAY 86400
...
// LFS uses Linux limits
#define LFS_XATTR_NAME_MAX 255
#define LFS_XATTR_SIZE_MAX 65536
#define LFS_XATTR_LIST_MAX 65536
...
#define DOWNLOAD_METADATA_LFS 1
#define DOWNLOAD_CHANGELOG_LFS 11
#define DOWNLOAD_CHANGELOG_LFS_1 12
#define DOWNLOAD_SESSIONS_LFS 2
...
// newchunkversion>0 && chunklength>=0 && chunklength<=LFSCHUNKSIZE && copychunkid==0 -> truncate
// newchunkversion>0 && chunklength>=0 && chunklength<=LFSCHUNKSIZE && copychunkid>0  -> duplicate and truncate
...
/// length==12+LFSBLOCKSINCHUNK*4 chunkid:64 chunkversion:32 checksums:(1024 * [checksum:32])
